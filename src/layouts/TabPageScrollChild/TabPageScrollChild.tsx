...
const TabPageScrollChild = ({
  ...
  return (
    <div className="safearea-pad-top h-safe-screen flex grow flex-col overflow-hidden bg-color-bg-lightmode-primary pb-tabs dark:bg-color-bg-darkmode-primary lg:pb-0">
      {isShowTopNav && (
        <TopNav
