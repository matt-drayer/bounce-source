export const WEBHOOK_LESSON_REMINDER_SEND = `${process.env.APP_URL}/api/webhooks/hasura/lesson-reminder-send`;
export const WEBHOOK_LESSON_REMINDER_CREATE = `${process.env.APP_URL}/api/webhooks/hasura/lesson-reminder-create`;
export const WEBHOOK_PLAY_SESSION_REMINDER_SEND = `${process.env.APP_URL}/api/webhooks/hasura/play-session-reminder-send`;
export const WEBHOOK_PLAY_SESSION_REMINDER_CREATE = `${process.env.APP_URL}/api/webhooks/hasura/play-session-reminder-create`;
