// @ts-nocheck
/**
 * @todo CREATE A VERSION OF THIS THAT USES TYPESCRIPT GENERICS AND CAN BE SHARED
 */
// import { sendPlaySessionStartReminder } from 'services/server/communications/email/sendPlaySessionStartReminder';
// import { EmailParams } from 'services/server/communications/email/sendPlaySessionStartReminder';
...
//   const sendPromises = items.map((item) => sendPlaySessionStartReminder(item)); // TODO: GET NEW EMAIL TEMPLATE
