...
import { fetchTriplesTournamentById } from 'services/server/airtable/edge';
...
export default async function handler(request: NextRequest) {
  ...
  const tournament = await fetchTriplesTournamentById(tournamentId);
    ...
    (
      ...
      >
        ...
        <div tw="flex justify-between items-center w-full">
          <div tw="flex flex-col">
            <div tw="flex text-white text-3xl font-bold">Triples Tournament</div>
