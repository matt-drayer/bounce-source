...
const CoachOnboardLocation: React.FC<StaticProps> = ({ countries, subdivisionsByCountry }) => {
  return (
    <OnboardLocation isCoach countries={countries} subdivisionsByCountry={subdivisionsByCountry} />
  );
};

export default CoachOnboardLocation;
